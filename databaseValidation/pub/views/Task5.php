	...
	<body>
		<div class="container-fluid blue">
			<div class="container title_head center-block">
				<h1 class><strong>Match architecture element with element type</strong></h1>
			</div>
		</div>
		...
		<?php
			...
			//BODY
			echo '
					<form method="POST" action=./index.php?page=processTask5>
					<div class="container text-center center-block">
						<div class="container">
							...
							<input class="btn deplace_but color_search" name="processing5" type="submit" value="Search">
						</div>
					</div>
					</form>';
