	...
	<body>
		<div class="container-fluid blue">
			<div class="container title_head center-block">
				<h1 class><strong>Recommand security control</strong></h1>
			</div>
		</div>
		...
		<?php
			...
			//BODY
			echo '<form method="POST" action=./index.php?page=processTask14>
					<div class="container text-center center-block">
						<div class="container">
							...
							try{
								...
								$query = "select name from 'public.vulnerability_type','public.vulnerability_type_control' where vulnerability_type_id = 'public.vulnerability_type'.id";
